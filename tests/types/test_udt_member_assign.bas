...
200 Copy = Container.Item
210 PRINT "Copy.Value = "; Copy.Value
220 PRINT "Copy.Label = "; Copy.Label
230 IF Copy.Value = 42 THEN PRINT "Value copy: PASS" ELSE PRINT "Value copy: FAIL"
240 IF Copy.Label = "Hello" THEN PRINT "Label copy: PASS" ELSE PRINT "Label copy: FAIL"
250 REM Verify independence after copy
260 Copy.Value = 100
270 Copy.Label = "World"
...
300 IF Copy.Value = 100 THEN PRINT "Modified copy value: PASS" ELSE PRINT "Modified copy value: FAIL"
310 IF Copy.Label = "World" THEN PRINT "Modified copy label: PASS" ELSE PRINT "Modified copy label: FAIL"
320 END
