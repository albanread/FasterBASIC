...
- [NEON SIMD Support](../articles/neon-simd-support.md) — how automatic vectorization works under the hood
- [Classes and Objects](../articles/classes-and-objects.md) — UDTs that benefit from SIMD
- [Quick Reference](FasterBASIC_QuickRef.md) — complete syntax reference
